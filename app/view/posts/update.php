...
<nav aria-label="breadcrumb">
  ...
  <div class="card-header bg-secondary text-white">
      <h2>Atualizar informacoes</h2>
    </div>
      <div class="card-body">
        
          <small>Preencha o formulário abaixo para Atualizar o post</small>
          <form name="login" method="POST" action="<?= URL ?>/posts/update/<?= $dados['id'] ?>" class="mt-4">
            ...
            <div class="form-group">
              ...
              <input type="text" name="telefone" id="telefone" maxlength = "13" onkeyup="mascara_telefone()" value="<?= $dados['telefone'] ?>" class="form-control <?php if(isset($dados['telefone_erro'])){echo $dados['telefone_erro'] ? 'is-invalid' : '';}; ?>" >
              <div class="invalid-feedback">
                    <?=  $dados['telefone_erro'] ?>
              </div>
            ...
            <div class="form-group">
              ...
              <input type="date" name="data_fundacao" id="data_fundacao"  value="<?= $dados['data_fundacao'] ?>" class="form-control <?php if(isset($dados['data_fundacao_erro'])){echo $dados['data_fundacao_erro'] ? 'is-invalid' : '';}; ?>">
              <div class="invalid-feedback">
